...
// 12 Pop Up Img
    ...
    const prev = sliderWrapper.querySelector('.slider-btn.prev');
    const next = sliderWrapper.querySelector('.slider-btn.next');
    ...
    // Observer para activar el slider cuando está visible
    const observer = new IntersectionObserver((entries) => {
        ...
        threshold: 0.5 // al menos el 50% del carrusel debe ser visible
    });
